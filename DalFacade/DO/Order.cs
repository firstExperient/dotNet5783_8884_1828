...
public struct Order
{
    ...
    /// <summary>
    /// the name of the customer that ordered an order
    /// </summary>
    public string CustomerName { get; set; }


    /// <summary>
    /// the email of the customer that ordered an order
    /// </summary>
    public string CustomerEmail { get; set; }


    /// <summary>
    /// the address of the customer, for knowing where to send the order to
    /// </summary>
